...
List<Animal> birdData = const [
  ...
  Animal(
    ...
    bgColor: Color(0xFFA54C93),
  ),
];

List<Animal> mammalData = const [
  Animal(
    name: "Rhinos",
  ...
  Animal(
    ...
    bgColor: Color(0xFF64443C),
  ),
];

List<Animal> fishData = const [
  Animal(
    name: "Gold Fish",
